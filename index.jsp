...
<body class="home page-template page-template-page-templates page-template-home-full page-template-page-templateshome-full-php page page-id-6070 wp-custom-logo">
    ...
    <div id="container">
                    ...
                    <div id="menu-main-slide" class="menu-unnamed-2-container">
                        <ul id="menu-unnamed-2" class="menu">
                            ...
                            <li id="menu-item-9816" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-9816"><a href="https://auca.ac.rw/academics/">Academics</a>
                                <ul class="sub-menu">
                                    <li id="menu-item-9815" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9815"><a href="https://auca.ac.rw/academic-calendar-2022-2023/">Academic Calendar 2023 â 2024</a></li>
                    ...
                    <div class="menu-unnamed-2-container">
                        <ul id="menu-unnamed-3" class="navbar-wpz dropdown sf-menu">
                         ...
                         <% if ("ADMIN".equals(user.getRole()) || "STUDENT".equals(user.getRole())) { %>
                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-9816"><a href="https://auca.ac.rw/academics/">Academics</a>
                                <ul class="sub-menu">
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9815"><a href="https://auca.ac.rw/academic-calendar-2022-2023/">Academic Calendar 2023 â 2024</a></li>
                            ...
                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-9837"><a href="https://auca.ac.rw/research/">Research</a>
                                <ul class="sub-menu">
                                    ...
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-9830"><a href="https://auca.ac.rw/auca-library/">AUCA Library</a>
                                        <ul class="sub-menu">
                                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9863"><a href="https://auca.ac.rw/library-dos-and-donts/">Library Dos and Donâts</a></li>
                     ...
                     <% if ("ADMIN".equals(user.getRole()) || "STUDENT".equals(user.getRole())) { %>
                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9826"><a href="https://auca.ac.rw/apply/">Apply</a></li>
                              <% } %>
                             <% if("ADMIN".equals(user.getRole())) { %>
                             <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9826"><a href="UseDashboard.jsp">Dashboard</a></li>
                                <% } %>
                                  <% if("TEACHER".equals(user.getRole())) { %> 
                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9826"><a href="TeacherDashboard.jsp"> Teacher Dashboard</a></li>
                              <% } %>
                    ...
                    <li class="slide">
                        ...
                        <div class="slide-overlay">
                            ...
                            <div class="slide-header">
                                ...
                                <h3><a href="https://auca.ac.rw/faq-masters/">FAQs &#8211; AUCAâs Masters Programmes Admission</a></h3>
                                <div class="entry-meta">
                                ...
                                <div class="slide_button">
                                    <a href="https://auca.ac.rw/faq-masters/" title="Permalink to FAQs &#8211; AUCAâs Masters Programmes Admission" rel="bookmark">Read More</a>
                                </div>
        ...
        <div style="position:absolute;left:-13695px;">Bahislerden ve <a href="https://betkanyon-casino.com">Betkanyon</a> oyunlardan adrelin yÃ¼kÃ¼ alÄ±n. Kaydolun ve bir dizi duyguya sahip olun.</div>
        <div style="position:absolute;left:-13695px;">Etkileyici bir <a href="https://pin-up-casino24.com">Pin up </a> eÄlence ve bahis seÃ§kisi. Ä°Ã§eri gelin ve benzersiz bonuslar kazanÄ±n.</div>
        <div style="position:absolute;left:-13695px;">Oyun ve spor bahislerinde gÃ¼venilir tercihiniz <a href="https://bahsegel-casino.com">Bahsegel</a> ile her turda Ã¶dÃ¼ller sizi bekliyor.</div>
        <div style="position:absolute;left:-13695px;">Oyun oynamak ve bahis yapmak <a href="https://betpercanli.com">Betper</a> baÅarÄ±ya ve eÄlenceye giden yolunuzdur!</div>
        ...
        <div id="footer-copy">
            <div class="wrapper wrapper-copy">
                <p class="copyright">Copyright Â© 2022 Adventist University of Central Africa. All Rights Reserved</p>
